...
class TestAuthBlueprint(BaseTestCase):
	...
	def test_registered_user_login_wrong_pw(self):
	    """ Test for login of registered-user login """
	    with self.client:
	        # user registration
	        resp_register = register_user(self, 'joe@gmail.com', '123456')
	        ...
	        response = login_user(self, 'joe@gmail.com', 'wrongPW') 
	        data = json.loads(response.data.decode())
	        self.assertTrue(data['status'] == 'fail')
	        self.assertTrue(data['message'] == 'Invalid password.')
	        self.assertTrue(response.content_type == 'application/json')
	        self.assertEqual(response.status_code, 401)

	def test_user_status(self):
		""" Test for user status of logged in user """
		with self.client:
			resp_register = register_user(self, 'joe@gmail.com', '123456')
			response = user_status(self, 
							dict(Authorization='Bearer ' + json.loads(
